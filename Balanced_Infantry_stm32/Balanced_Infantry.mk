...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Balanced_Infantry_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -ID:/STUDYW~1/MYPROG~1/TUP_20~3  -ID:/STUDYW~1/MYPROG~1/TUP_20~3/Balanced_Infantry_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -ID:/MATLAB/STM32-MAT/STM32/addSrc/inc 
...
%.o: $(subst ",,D:/MATLAB/STM32-MAT/STM32/addSrc/src)/%.cpp
	@echo ### Source $< done
...
%.o: $(subst ",,D:/MATLAB/STM32-MAT/STM32/addSrc/src)/%$(SRC_FILE_EXT)
	@echo ### Source $< done
